...
;; THURSDAY 3 JANUARY 2019 : DC1
;; From trsubzdf.pro 
;; change to remove the vertical contribution of iso-neutral mixing

FUNCTION trsubzdf_v2, p2dt, ptb,wslpi,wslpj,mldlev, fsavs, aht0
@common
;%       !!----------------------------------------------------------------------
;%       !!                  ***  ROUTINE tra_zdf_imp  ***
;%       !!
